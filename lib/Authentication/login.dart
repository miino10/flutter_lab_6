...
import 'package:flutter_lab_6/Authentication/signup.dart';
import 'package:flutter_lab_6/JsonModels/users.dart';
import 'package:flutter_lab_6/SQLite/sqlite.dart';
import 'package:flutter_lab_6/Views/notes.dart';
            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  // We will disable this message in default, when user and pass is incorrect we will trigger this messageto user
                  isLoginTrue
                      ? const Text(
